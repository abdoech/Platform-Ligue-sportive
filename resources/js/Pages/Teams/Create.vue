    ...
    <div class="min-h-screen bg-gray-100">
        <div class="max-w-3xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-6">Créer une équipe</h1>

                <form @submit.prevent="form.post('/admin/teams')" class="bg-white shadow rounded-lg p-6 space-y-4">
                    <div>
                    ...
                    <div class="flex gap-3 pt-4">
                        ...
                        <a href="/admin/teams" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded">
                            Annuler
                        </a>
                    </div>
                </form>
